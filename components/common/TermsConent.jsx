        ...
        <div className="col-lg-9">
          ...
          <TabPanel>
            <div className="tabs__content js-tabs-content text-15 text-dark-1" data-aos="fade">
              ...
              <div className="mb-20">
              <div>
                <p className="text-15 text-dark-1 mt-5">This privacy notice for Dream Tourism Limited ('we', 'us', or 'our'), describes how and why we might collect,store, use, and/or share ('process') your information when you use our services ('Services'), such as when you: </p>
                <ul className="mt-5 pl-80 mt-5 pl-80 listStyle">
                  <li >Visit our website at <a className='text-primary' href='https://dreamtourism.co.uk'>https://dreamtourism.co.uk/</a>, or any website of ours that links to this privacy notice</li>
                  <li>Engage with us in other related ways, including any sales, marketing, or events</li>
                </ul>
                <p className="text-15 text-dark-1 mt-5">Questions or concerns? Reading this privacy notice will help you understand your privacy rights and choices. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at sales@dreamtourism.it.</p>
              </div>
              </div>
              <div className="mb-20">
                ...
                <p className="text-15 text-dark-1 mt-5 text-justify">What personal information do we process? When you visit, use, or navigate our Services, we may process personal information depending on how you interact with us and the Services, the choices you make, and the products and features you use. Learn more about personal information you disclose to us.</p>
                ...
                <p className="text-15 text-dark-1 mt-5 text-justify">
                How do you exercise your rights? The easiest way to exercise your rights is by visiting <a className='text-primary' href='https://dreamtourism.co.uk/contact/'>https://dreamtourism.co.uk/contact/</a> or by contacting us. We will consider and act upon any request in accordance with applicable data protection laws.
                </p>
                <p className="text-15 text-dark-1 mt-5 text-justify">
              ...
              <div>
                <p className="text-15 text-dark-1 mt-5 text-justify">
                If you have questions or comments about this notice, you may email us at sales@dreamtourism.it or contact us by post at:
                </p>
                <div className="row">
                  <div className="col-md-3">
                    <h6 className='pb-10'>Dream Tourism Limited</h6>
                    <h6>Address: </h6>
                    <span>Unit-6, 736-740 Romford Road, London E12 6BT United Kingdom</span>
                  </div>
                </div>
              </div>
              </section>
              ...
              <div>
                ...
                Based on the applicable laws of your country, you may have the right to request access to the personal information we collect from you, change that information, or delete it. To request to review, update, or delete your personal information, please visit: <br></br>
                <a className='text-primary' href='https://dreamtourism.co.uk/contact/'>https://dreamtourism.co.uk/contact/</a>
                </p>
              </div>
              </section>
